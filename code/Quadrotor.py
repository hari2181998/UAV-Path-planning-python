...
class Quadrotor():
    def __init__(self, x=0, y=0, z=0, roll=0, pitch=0, yaw=0, size=0.25, show_animation=True,obstacles=[],goal=[],path=[]):
    ...
    def plot(self):  # pragma: no cover
        ...
        self.ax.plot(obstacles[0],obstacles[1],obstacles[2],'ks')
        self.ax.plot(path_f[0],path_f[1],path_f[2],'r-')
        #self.ax.plot(goal[0],goal[1],goal[2],'y^')
